...
export type ProviderKey='VEO'|'HUGGING_FACE'|'MOCK';
export interface VideoGenerationResult { id:string; status:string; videoUrl?:string; message?:string; provider?:ProviderKey; }
